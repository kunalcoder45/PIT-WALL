...
// f1 video game simulation telemetry viewer, with live track map and lap-by-lap leaderboard.
...
//             cancelled = true;
//         };
//     }, [showTelemetry, raceSession, laps, lapNumber, driverNumbers]);
...
//                     className="rounded-sm border border-red bg-red/10 px-4 py-2 font-mono text-sm text-red hover:bg-red hover:text-white transition"
//                 >
//                     {showTelemetry ? "Telemetry Active" : "Load Telemetry"}
//                 </button>
//             </div>
...
//                                 <button
//                                     onClick={() => setShowTelemetry(true)}
//                                     className="mt-4 rounded-sm bg-red px-5 py-2 text-sm font-display uppercase text-white"
//                                 >
//                                     Load Lap Telemetry
//                                 </button>
//                             </div>
